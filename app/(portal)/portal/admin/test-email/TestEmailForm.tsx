    ...
    <div className="max-w-md space-y-6">
      ...
      <form action={formAction} className="space-y-4 rounded-xl border border-white/10 bg-ink-900/60 p-6">
        <div>
          ...
          <Input id="to" name="to" type="email" required className="mt-2 border-white/15 bg-ink-950/50 text-white" placeholder="seu@email.com" />
        </div>
        ...
        <button type="submit" disabled={pending} className="w-full rounded bg-brand-yellow px-6 py-3 text-small font-bold uppercase tracking-wider text-ink-950 hover:bg-white disabled:opacity-50">
